...
#ejercicio 2 Flask_API_retrain_db\ejercicio\advertising.db
...
def createdb():
    ...
    con = sqlite3.connect(r'./1-Flask/1-Routing/ejercicios/ejercicio 2 Flask_API_retrain_db/ejercicio/advertising.db')
    cur = con.cursor()
    cur.execute("DROP TABLE IF EXISTS t;")
    cur.execute("CREATE TABLE t (TV, radio, newspaper, sales);")

    with open(r'1-Flask/1-Routing/ejercicios/ejercicio 2 Flask_API_retrain_db/ejercicio/advertising.csv', 'r') as fin:
...
def predict():
    ...
    if 'TV' in args and 'radio' in args and 'newspaper' in args:
        with open(r'1-Flask/1-Routing/ejercicios/ejercicio 2 Flask_API_retrain_db/ejercicio/advertising.model', 'rb') as archivo_entrada:
...
def retrain():
    try:
        ...
        pickle.dump(lin_reg, open(r'./1-Flask/1-Routing/ejercicios/ejercicio 2 Flask_API_retrain_db/ejercicio/advertising.model', 'wb'))
